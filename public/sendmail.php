...
require_once __DIR__ . '/../routes/sendmail.php';
...
{
    $request_uri = explode('/sendmail', trim($_SERVER['REQUEST_URI'], '/sendmail'));
    $script_name = explode('/sendmail', trim($_SERVER['SCRIPT_NAME'], '/sendmail'));
    $parts = array_diff_assoc($request_uri, $script_name);
    if (empty($parts)) {
        return '/sendmail';
    }
    $path = implode('/sendmail', $parts);
